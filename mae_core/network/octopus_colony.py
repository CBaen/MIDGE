...
from .octopus_monitoring import OctopusMonitoringMixin
...
class OctopusColony(OctopusMonitoringMixin):
    ...
    # Monitoring methods (_monitoring_loop, _check_health, _check_workload_scaling,
    # _publish_health_report) are in OctopusMonitoringMixin.
