...
Sub-modules:
  house_stock_normalizer.py — normalize_trade (RapidAPI + HouseStockWatcher format)
"""
...
from mae_core.market.apis.house_stock_normalizer import normalize_trade as _normalize_trade_fn
...
class HouseStockWatcherClient:
    ...
    def _normalize_trade(self, item: dict) -> Optional[dict]:
        ...
        Delegates to house_stock_normalizer.normalize_trade() which handles
        both RapidAPI and House Stock Watcher formats.
        """
        return _normalize_trade_fn(item)
