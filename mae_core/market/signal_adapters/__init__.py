"""Signal adapter subpackage — all 41 from_* converter functions.
...
Module layout:
    ...
    wave2_3      — Crypto, OpenInsider, 13F, FinViz, Finnhub real-time, suppression,
                   economic_surprise, Kalshi (11 functions)
"""
