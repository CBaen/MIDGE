"""Signal adapter subpackage — all 42 from_* converter functions.
...
Module layout:
    ...
    wave2_3      — Crypto, OpenInsider, 13F holdings + filer activity, FinViz, Finnhub real-time,
                   suppression, economic_surprise, Kalshi (12 functions)
"""
