...
from mae_core.backbone.connection_registry_verification import (
    ConnectionVerificationMixin,
)
...
class ConnectionRegistry(ConnectionVerificationMixin):
    ...
    # =========================================================================
    # Topological Invariants (delegated to connection_registry_topology.py)
    # =========================================================================

    def get_euler_statistics(self) -> dict[str, Any]:
        """Compute topological invariants of the connection graph."""
        from mae_core.backbone.connection_registry_topology import (
            get_euler_statistics as _compute_euler,
        )
        with self._lock:
            return _compute_euler(self._connections)

    def check_euler_invariant(self) -> dict[str, Any]:
        """Advisory check: report topological invariants."""
        from mae_core.backbone.connection_registry_topology import (
            check_euler_invariant as _check_euler,
        )
        with self._lock:
            return _check_euler(self._connections)
