...
- **3,417 tests pass, 0 failures** (66 new tests: correlation tracker wiring, causal bridge, absence monitor)
...
8. **3,417 tests must keep passing.** Zero regressions. Run `python -m pytest tests/ -q` to verify.
